...
class TestCleanData(unittest.TestCase):
	...
	def test_affected_indexes_case_1(self):
		result = clean_data.get_affected_message_indexes_per_STATE( 2, ['1', '1', '1', '1', '1'], ['A', 'A', 'STATE', 'A', 'A'], ['1', '2', '12', '18', '60'])
	...
	def test_affected_indexes_case_2(self):	
		result = clean_data.get_affected_message_indexes_per_STATE( 2, ['1', '1', '1', '1', '1'], ['A', 'A', 'STATE', 'W', 'A'], ['1', '2', '3', '9', '60'])
	...
	def test_affected_indexes_case_3(self):	
		result = clean_data.get_affected_message_indexes_per_STATE( 2, ['1', '1', '1', '1', '1'], ['A', 'A', 'STATE', 'W', 'A'], ['1', '2', '12', '14', '17'])
